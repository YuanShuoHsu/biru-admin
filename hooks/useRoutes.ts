    ...
    children: [
      {
        children: [
          {
            icon: HowToReg,
            label: "attendance.mine.label",
            query: ["organization", "page", "pageSize"],
            segment: "shifts",
          },
          {
            icon: PendingActions,
            label: "attendance.requests.label",
            query: ["organization", "page", "pageSize"],
            segment: "requests",
          },
          {
      ...
      },
      {
        children: [
          ...
          {
            icon: EventRepeat,
            label: "attendance.holidaySubstitutes.label",
            query: ["organization", "page", "pageSize"],
            segment: "holiday-substitutes",
          },
        ],
        icon: EventAvailable,
        label: "attendance.groups.schedule",
        segment: "schedule",
        to: null,
      },
      {
        children: [
          {
            icon: EventNote,
            label: "attendance.shifts.label",
            query: ["organization", "page", "pageSize"],
            segment: "shifts",
          },
          {
            icon: FactCheck,
            label: "attendance.reviews.label",
            query: ["organization", "page", "pageSize"],
            segment: "reviews",
          },
        ],
        icon: ListAlt,
        label: "attendance.groups.records",
        segment: "records",
        to: null,
      },
      {
        children: [
          {
            ...
            label: "attendance.balances.label",
            query: ["organization", "page", "pageSize"],
            segment: "balances",
          },
          {
            icon: FolderShared,
            label: "attendance.leaveCases.label",
            query: ["organization", "page", "pageSize"],
            segment: "cases",
          },
          {
            icon: Stroller,
            label: "attendance.parentalChildren.label",
            query: ["organization", "page", "pageSize"],
            segment: "parental-children",
          },
          {
            icon: AssignmentReturn,
            label: "attendance.parentalReturns.label",
            query: ["organization", "page", "pageSize"],
            segment: "parental-returns",
          },
        ],
        icon: BeachAccess,
        label: "attendance.groups.leave",
        segment: "leave",
        to: null,
      },
      {
      ...
      },
      {
        ...
        icon: Settings,
        label: "attendance.groups.settings",
        segment: "settings",
        to: null,
      },
    ],
